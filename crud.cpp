...
void modificarEstudiante() {
    ifstream archivo("estudiantes.txt"); //se lee el archivo que ya estaba creado en el crud
    ofstream temp("temp.txt"); // se ocupa el mismo archivo temp de abajo, en general no se cambian las variables
    Estudiante e; 
    string buscado;
    ...
    if (archivo.is_open() && temp.is_open()) {
        while (archivo >> e.nombre >> e.carnet >> e.edad) {
            if (e.carnet == buscado) {
                Estudiante nuevo;
                cout << "Nuevo nombre (pero no debes dejar espacios): ";
                cin >> nuevo.nombre;
                cout << "Nuevo carnet a ingresar: ";
                cin >> nuevo.carnet;
                cout << "Nueva edad a ingresar: ";
                cin >> nuevo.edad;
